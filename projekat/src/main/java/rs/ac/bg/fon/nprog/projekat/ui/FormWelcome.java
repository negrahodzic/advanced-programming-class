...
public class FormWelcome extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FormWelcome frame = new FormWelcome();
	...
	public FormWelcome() {
        ...
        jLabel1.setIcon(new ImageIcon(FormWelcome.class.getResource("/src/main/resources/imgStar.png"))); // NOI18N
